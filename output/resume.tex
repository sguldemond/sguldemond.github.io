...
\startitemize[packed]
\item
  Currently: Lead developer at the
  \useURL[url1][https://www.odk.ai][][Object Detection Kit]\from[url1]
  project (see Projects)
\item
  Previously:
  \useURL[url2][https://www.vimeo.com/384562767][][Presenting the Decode
  Digital Identity project in Turin, Italy]\from[url2] (see Projects)
\stopitemize
...
\startitemize[packed]
\item
  \useURL[url3][mailto:stanguldemond@gmail.com][][stanguldemond@gmail.com]\from[url3]
\item
  +31625405664
\item
...
\item
  Dutch, 29 y/o
\item
  \useURL[url4][https://www.linkedin.com/in/stan-guldemond-56291b120/][][LinkedIn]\from[url4],
  \useURL[url5][https://github.com/sguldemond/][][GitHub]\from[url5],
  \useURL[url6][https://gitlab.com/users/stanguldemond/contributed][][GitLab]\from[url6],
  \useURL[url7][https://stackshare.io/sguldemond][][Stackshare]\from[url7]
\stopitemize
...
\item
  Python 3:
  \useURL[url8][https://flask.palletsprojects.com/][][Flask]\from[url8],
  \useURL[url9][fastapi.tiangolo.com/][][FastAPI]\from[url9],
  \useURL[url10][https://www.sqlalchemy.org/][][SQLAlchemy]\from[url10],
  \useURL[url11][https://pypi.org/project/aio-pika/][][aio-pika]\from[url11],
  \useURL[url12][https://docs.python.org/3/library/typing.html][][typing]\from[url12],
  \useURL[url13][https://docs.pytest.org][][pytest]\from[url13], PEP 8,
  virtual environments
\item
  PostgreSQL:
  \useURL[url14][https://postgis.net/][][PostGIS]\from[url14],
  \useURL[url15][https://www.postgresql.org/docs/9.2/app-psql.html][][psql
  cli]\from[url15], user management, foreign tables, (materialized)
  views, indexes,
  \useURL[url16][https://www.pgadmin.org/][][pgAdmin]\from[url16]
\item
...
\startitemize[packed]
\item
  \useURL[url17][https://www.odk.ai][][Project website]\from[url17]
\item
  \useURL[url18][https://www.gitlab.com/odk/odk-stack][][Open source
  repository]\from[url18]
\item
  \useURL[url19][https://www.gitlab.com/odk][][All ODK
  projects]\from[url19]
\stopitemize
...
This project made money available for continues research and development
of the use of digital identity in the City of Amsterdam.

\startitemize[packed]
\item
  \useURL[url20][https://www.vimeo.com/384562767][][Me presenting the
  project in Turin, Italy]\from[url20]
\item
  \useURL[url21][https://www.github.com/Amsterdam/decode_passport_scanner][][GitHub
  repository]\from[url21]
\item
  \useURL[url22][https://www.youtube.com/watch?v=p1KLvwV7oIM][][Quick
  demo]\from[url22]
\item
  \useURL[url23][https://www.decodeproject.eu][][Decode
  Project]\from[url23]
\stopitemize
...
\startitemize[packed]
\item
  \useURL[url24][https://www.github.com/amsterdam/gutter][][Outdated
  repository]\from[url24]
\stopitemize
